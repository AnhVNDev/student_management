...
@Component({
  selector: 'app-request-verification-fee',
  templateUrl: './request-verification-fee.component.html',
  styleUrls: ['./request-verification-fee.component.css']
})
export class RequestVerificationFeeComponent  implements OnInit, OnDestroy {

  ref!: DynamicDialogRef;

  
  show() {
    this.ref = this.dialogService.open(ModalEditRequestComponent, {
