...
export class ApiService  {
  ...
  getAllPayment() : Observable<any> {
    ...
    return this.http.get(this.api + 'payment', {headers:headers, responseType: 'json'})//stringify de chuyen doi tu object sang json
  }
  ...
  deletePamentStudent(id: any) : Observable<any> {
    ...
    return this.http.delete(this.api + `deletePayment/${id}`, {headers: headers, responseType: 'json'})//stringify de chuyen doi tu object sang json
  }
  ...
  sendEmail(data: any): Observable<any> {
    ...
    return this.http.post(this.api + 'send-email', data, {headers:headers, responseType: 'json'})//stringify de chuyen doi tu object sang json
  ...
  saveFee(Id: string = '' , formData : FormData): Observable<any> {
    ...
    if(Id == undefined || Id == null || Id == ''){
      return this.http.post(this.api + 'addFee', data,{ headers: headers, responseType: 'json' });
      ...
      console.log(object);
      return this.http.post(this.api + `updateFee/${Id}`, object,{ responseType: 'text' });
  ...
  createNewAccount(account: Object){    
    ...
    const headers = new HttpHeaders().set('Content-Type', 'application/json') ;
    return this.http.post(this.api + 'createNewStudent', userInfo, {headers:headers, responseType: 'text'})//stringify de chuyen doi tu object sang json
  }
